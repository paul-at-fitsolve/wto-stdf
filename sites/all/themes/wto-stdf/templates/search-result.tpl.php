...
<li class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <div class="search-snippet-info">
   <?php if ($snippet && $variables['result']['entity_type'] == 'node'): ?>
  ...
  <?php if ($variables['result']['entity_type'] == 'file'):?>
  <div class="metadata_label">Author<?php print ((count($variables['authors'])>1)?'s':null) . ' :';?>
